...
DROP POLICY IF EXISTS "Users can insert questions for their quizzes" ON questions;
...
DROP POLICY IF EXISTS "Users can insert answers for their questions" ON answers;
...
DROP POLICY IF EXISTS "Users can update answers for their questions" ON answers;
...
DROP POLICY IF EXISTS "Users can delete answers for their questions" ON answers;
